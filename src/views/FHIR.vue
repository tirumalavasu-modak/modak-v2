<template>
  <div class="max-w-3xl mx-auto my-16 m-pad">
    ...
    <p class="border-l-4 border-blue-500 pl-4 my-8 italic">
      Enabling FHIR will help health care providers serve their customers better by improving interoperability. The faster implementation of FHIR requires handling data integration challenges and building use cases with RESTful APIs rapidly.
    </p>
    ...
    <p>
      Alternatively, a promising and faster approach is to replace the FHIR data store with thin templates provided by Modak’s Fireshots. The approach eliminates the necessity of storing data in FHIR compliant data model and lifts the burden off enterprise teams to maintain FHIR data model and associate servers.
    </p>
    <h4 class="my-4">
